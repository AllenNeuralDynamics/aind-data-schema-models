...
class _University_Of_Pennslvania(OrganizationModel):
    """Model University of Pennslvania"""

    name: Literal["University of Pennslvania"] = "University of Pennslvania"
...
class Organization:
    ...
    PENN = _University_Of_Pennslvania()
    VIEWORKS = _Vieworks()
    VORTRAN = _Vortran()
